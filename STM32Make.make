...
GCC_PATH="C:/DEV/DEV_TOOLS/GCC-ARM-NONE-EABI-10.3-2021.10/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/DEV/DEV_TOOLS/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/DEV/DEV_TOOLS/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f3x mass_erase 0; exit"
